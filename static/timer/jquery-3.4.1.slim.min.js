...
!(function (e, t) {
					...
					(p.qsa = J.test(T.querySelectorAll)) &&
						(ce(function (e) {
							;(a.appendChild(e).innerHTML =
								"<a id='" + N + "'></a><select id='" + N + "-\r\\' msallowcapture=''><option selected=''></option></select>"),
						...
						: function (e, t, n) {
								...
								if (c) {
									...
									if (((u = [m ? c.firstChild : c.lastChild]), m && d)) {
										;(p =
											(s =
												(r = (i = (o = (a = c)[N] || (a[N] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === A &&
												r[1]) && r[2]),
											(a = s && c.childNodes[s])
										...
										(d &&
											(p = s =
												(r = (i = (o = (a = e)[N] || (a[N] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === A &&
												r[1]),
										!1 === p)
									)
										while ((a = (++s && a && a[l]) || (p = s = 0) || u.pop()))
											if (
												...
												++p &&
												(d && ((i = (o = a[N] || (a[N] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] = [A, p]), a === e)
											)
												break
		...
		(Y.prototype = {
			cache: function (e) {
				...
				return (
					t ||
						((t = {}),
						Q(e) && (e.nodeType ? (e[this.expando] = t) : Object.defineProperty(e, this.expando, { value: t, configurable: !0 }))),
					t
				)
			},
			set: function (e, t, n) {
			...
			E.event.special[e] = {
				...
				handle: function (e) {
					var t,
						...
						r = e.handleObj
					return (
						(n && (n === this || E.contains(this, n))) || ((e.type = r.origType), (t = r.handler.apply(this, arguments)), (e.type = i)), t
					)
				},
			}
		}),
	...
	function Ie(e, t) {
		...
		if (1 === t.nodeType) {
			if (G.hasData(e) && ((o = G.access(e)), (a = G.set(t, o)), (l = o.events)))
				for (i in (delete a.handle, (a.events = {}), l)) for (n = 0, r = l[i].length; n < r; n++) E.event.add(t, i, l[i][n])
			...
			E.cssHooks[u] = {
				...
				set: function (e, t, n) {
					...
					return (
						a &&
							o &&
							(s -= Math.ceil(e['offset' + u[0].toUpperCase() + u.slice(1)] - parseFloat(i[u]) - tt(e, u, 'border', !1, i) - 0.5)),
	...
	;(E.param = function (e, t) {
		...
		(b.createHTMLDocument =
			(((pt = v.implementation.createHTMLDocument('').body).innerHTML = '<form></form><form></form>'), 2 === pt.childNodes.length)),
