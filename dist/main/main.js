...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "5241de8a8b4dfd64d635";
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* WEBPACK VAR INJECTION */(function(__dirname) {/* harmony import */ var electron__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! electron */ \"electron\");\n/* harmony import */ var electron__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(electron__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var url__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! url */ \"url\");\n/* harmony import */ var url__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(url__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! path */ \"path\");\n/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(path__WEBPACK_IMPORTED_MODULE_2__);\n\n\n\nconst log = __webpack_require__(/*! electron-log */ \"electron-log\");\nconst { autoUpdater } = __webpack_require__(/*! electron-updater */ \"electron-updater\");\nautoUpdater.logger = log;\nautoUpdater.logger.transports.file.level = 'info';\nlet mainWindow;\nconst isDevelopment = \"development\" !== 'production';\nfunction createMainWindow() {\n    // console.log(__static, '45tyui')\n    const window = new electron__WEBPACK_IMPORTED_MODULE_0__[\"BrowserWindow\"]({\n        webPreferences: {\n            nodeIntegration: true,\n            enableRemoteModule: true,\n            webSecurity: false,\n        },\n        width: 1440,\n        height: 900,\n        minHeight: 675,\n        minWidth: 1080,\n        icon: isDevelopment ? './app/logo.png' : path__WEBPACK_IMPORTED_MODULE_2__[\"join\"](__dirname, '/icon/Icon-512x512.png'),\n    });\n    if (isDevelopment) {\n        window.webContents.openDevTools();\n    }\n    if (isDevelopment) {\n        // noinspection JSIgnoredPromiseFromCall\n        window.loadURL(`http://localhost:${process.env.ELECTRON_WEBPACK_WDS_PORT}`);\n    }\n    else {\n        // noinspection JSIgnoredPromiseFromCall\n        window.loadURL(Object(url__WEBPACK_IMPORTED_MODULE_1__[\"format\"])({\n            pathname: path__WEBPACK_IMPORTED_MODULE_2__[\"join\"](__dirname, 'index.html'),\n            protocol: 'file',\n            slashes: true,\n        }));\n    }\n    window.on('closed', () => {\n        mainWindow = null;\n    });\n    window.webContents.on('devtools-opened', () => {\n        window.focus();\n        setImmediate(() => {\n            window.focus();\n        });\n    });\n    return window;\n}\nconst monitor = __webpack_require__(/*! active-window */ \"active-window\");\nelectron__WEBPACK_IMPORTED_MODULE_0__[\"app\"].on('ready', () => {\n    createMainWindow();\n    // setInterval(() => {\n    // \tgetFile('',(data)=>{\n    // \t})\n    // }, 5000)\n});\n\n/* WEBPACK VAR INJECTION */}.call(this, \"\"))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./index.ts\n");
